...
- **Manual weight adjustment:** The idle Train screen has −/+ steppers per exercise (same as mid-session) that write to `weights` directly, floored at the empty 20kg bar
