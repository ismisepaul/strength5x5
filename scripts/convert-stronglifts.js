...
const csvPath = process.argv[2] || resolve(__dirname, '../../Downloads/Stronglifts20260315.csv');
...
const outPath = resolve(__dirname, '..', 'stronglifts_import.json');
writeFileSync(outPath, JSON.stringify(output, null, 2));

console.log(`Converted ${history.length} sessions, ${rows.length} exercise rows`);
console.log(`Current weights:`, currentWeights);
console.log(`Next workout type: ${nextType}`);
